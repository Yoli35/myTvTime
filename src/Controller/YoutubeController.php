...
class YoutubeController extends AbstractController
{
    ...
    public function index(Request $request, YoutubeVideoRepository $repository, YoutubeVideoThumbnailDimensionRepository $youtubeVideoThumbnailDimensionRepository, YoutubeChannelThumbnailDimensionRepository $youtubeChannelThumbnailDimensionRepository): Response
    {
        /** @var User $user */
        $user = $this->getUser();
